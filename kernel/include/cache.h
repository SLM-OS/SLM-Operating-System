 ...
 * Unlike CIVAC, this does NOT write dirty data back to PoC first.
 * Use when the caller has already cleaned all important data and
 * wants to force a fresh read from PoC without risk of overwriting
 * another CPU's updates during the writeback phase.
 *
