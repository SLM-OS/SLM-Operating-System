...
|------|------|--------|---------|
| Weight | 32 MB | 16 | Model weights (read-only after load) |
| Workspace | 16 MB | 8 | Inference scratch space |
| **Total** | **48 MB** | **24** | Reserved for model memory |
