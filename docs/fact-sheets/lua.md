...
| `slm.*` binding surface (admin) | component_run, component_hot_swap, component_hot_swap_stateful, model_load, model_load_mnist, model_swap, model_pin, model_unpin, model_preload, model_preload_wait, model_infer, model_bench, sched_set_policy, task_create, task_kill, task_set_priority, task_pin, task_migrate, eviction_set_policy, shell_exec, telnetd_start, telnetd_stop, telnetd_kick, telemetryd_start, telemetryd_stop, telemetryd_kick | Same | Same | Same |
