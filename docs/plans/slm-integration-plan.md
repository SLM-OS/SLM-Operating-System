...
[`docs/fact-sheets/slm-integration.md`](../fact-sheets/slm-integration.md). Brings
...
- ☐ Update `docs/fact-sheets/slm-integration.md` matrix with measured ✅ vs goal
  ✅.
...
- [`docs/fact-sheets/slm-integration.md`](../fact-sheets/slm-integration.md) — the
