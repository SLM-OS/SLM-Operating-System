...
#define SLMOS_XHCI_SLOT3_HANDOFF_CTX_DCIS 7U
#define SLMOS_XHCI_SLOT3_HANDOFF_EP_DWORDS 8U
#define SLMOS_XHCI_SLOT3_HANDOFF_PAYLOAD_U64S \
    (4U + 4U + \
     (SLMOS_XHCI_SLOT3_HANDOFF_CTX_DCIS * SLMOS_XHCI_SLOT3_HANDOFF_EP_DWORDS))
#define SLMOS_XHCI_SLOT3_DEVCXT_MIRROR_PHYS 0xBDE01000UL
#define SLMOS_XHCI_SLOT3_INPUT_CTX_PHYS     0xBDE02000UL
#define SLMOS_XHCI_SLOT3_EP0_RING_PHYS      0xBDE03000UL
#define SLMOS_XHCI_SLOT3_EP0_RING_SIZE      0x00002000UL
#define SLMOS_XHCI_SLOT3_RESERVED_BYTES     0x00005000UL
#define SLMOS_XHCI_SLOT3_EP0_RING_TRBS      64U
#define SLMOS_XHCI_SLOT3_EP0_RING_BYTES     (SLMOS_XHCI_SLOT3_EP0_RING_TRBS * 16U)
